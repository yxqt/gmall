...
public class CategoryController {
    ...
    @ApiOperation("商品分类")
    public ResponseVo<List<CategoryEntity>> queryCategoryByid(@PathVariable("parentId")Long parentId){
        List<CategoryEntity> categoryEntities = categoryService.queryCategoryByid(parentId);
